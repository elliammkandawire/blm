...
<head>
  ...
  <title>Banja | Finance | Stock Take</title>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="stock-take.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Stock take</p>
                </a>
              </li>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="table-responsive">
                <!-- table start -->
               <table id="stockTakeTable" class="table table-striped table-advance table-bordered">
                ...
                ?>
                  ...
                  <?php 
                     ...
                     <?php 
                      ...
                      echo '<tr><td colspan="20" class="text text-danger font-weight-bold">There are currently no item details to display</td></tr>';
                    }?>
                </tbody>
              </table>
              <!-- /.end table -->
