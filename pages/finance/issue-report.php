    ...
    if (!isset ($_SESSION['finance']))
      ...
      if(isset($_POST['start']) && isset($_POST['end'])){
          ...
          $results = $connection->query("SELECT *  
                                    ...
                                    JOIN stock_usage 
                                    ON item.item_id = stock_usage.item_id
									WHERE stock_usage.date_taken BETWEEN '$start' AND '$end'
      ...
      if(isset($_POST["export-stock"])) 
	   {	
	      $filename = "stock-take-".date('d-m-y'). ".xls";			
...
<head>
  ...
  <title>Banja | Finance | Issue Report</title>
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
               ...
               <li class="nav-item">
                <a href="issue-report.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Issue Report</p>
                </a>
              </li>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Issued Stock Details</h3>
            ...
            <div class="table-responsive">
              ...
              <!-- /.end table -->
                ...
                <nav aria-label="...">
                    ...
                    <?php if($page > 1){ ?>
                    <li class="page-item">
                        <a class="page-link" href="issue-report.php?page=<?= $previous; ?>">Previous</a>
                      </li>
                      <?php 
                       } else { ?>
                      ...
                      <li class="page-item <?= $page == $i ? 'active':'' ?>" aria-current="page">
                            <a class="page-link" href="issue-report.php?page=<?= $i; ?>"><?= $i; ?></a>
                      </li>
                      <?php endfor; ?>
                       
                      <?php if(($i > $page) && ($page < $pages)){ ?>
                      <li class="page-item">
                        <a class="page-link" href="issue-report.php?page=<?= $next; ?>">Next</a>
                      </li>
                      <?php 
                       } else { ?>
                      <li class="page-item disabled">
