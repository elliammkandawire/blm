<?php
    ...
    if (!isset ($_SESSION['finance']))
	  ...
	  {	
	      $filename = "donated-report-".date('d-m-y'). ".xls";			
...
<head>
  ...
  <title>Banja | Finance | Donated Report</title>
        ...
        <?php
               if(mysqli_num_rows($query)>0){
                   ...
                   while($result = mysqli_fetch_assoc($query))
                   {
                    ...
                    echo'<a href="#" class="dropdown-item dropdown-footer">See All Requisitions</a>';
                }
                else{
                  echo'
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
			  ...
			  <li class="nav-item">
                <a href="donated-report.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Donated Report</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Donated Report</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="finance-dash.php">Home</a></li>
              <li class="breadcrumb-item active">Donated Report</li>
            </ol>
          </div>
        </div><!-- /.row -->
        <?php if($sess)
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Donated Report</h3>
