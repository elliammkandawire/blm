...
<head>
  ...
  <title>Banja | Procurement | requisition summary</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="requisition-summary" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">All Requisition</h3>
              ...
              <!-- /.card-header -->
               <!-- Card start -->
                <div class="card-body">
                <!-- table start -->
                <table id="table" class="table table-striped table-advance table-hover table-bordered">
                ...
                <tbody> 
                  ...
                  <tr>
                     ...
                     <?php 
                      ...
                      echo '<tr><td colspan="9" class="text text-danger font-weight-bold">There are currently no any requisitions</td></tr>';
                    }?>
                </tbody>
              </table>
              <!-- /.end table -->
                ...
                <div class="card-footer">
                   ...
                   <nav aria-label="...">
                    ...
                    <?php if($page > 1){ ?>
                    <li class="page-item">
                        <a class="page-link" href="denied-requisition?page=<?= $previous; ?>">Previous</a>
                      </li>
                      <?php 
                       } else { ?>
                      ...
                      <li class="page-item <?= $page == $i ? 'active':'' ?>" aria-current="page">
                            <a class="page-link" href="denied-requisition?page=<?= $i; ?>"><?= $i; ?></a>
                      </li>
                      <?php endfor; ?>
                       
                      <?php if(($i > $page) && ($page < $pages)){ ?>
                      <li class="page-item">
                        <a class="page-link" href="denied-requisition?page=<?= $next; ?>">Next</a>
                      </li>
                      <?php 
                       } else { ?>
                      <li class="page-item disabled">
