...
<head>
  ...
  <title>Banja | Procurement | Stock Level</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Low Stock level Items</h3>
                ...
                <?php 
                  ...
                  <tr>
                      ...
                      <?php }
                        ...
                        echo '<tr><td colspan="10" class="text text-danger font-weight-bold">There are currently no item with low stock level</td></tr>';
                      }
                      ?>
                </tbody>
              </table>
