<?php
    ...
    if (!isset ($_SESSION['procurement-officer']))
        ...
        {
            $requisitionId =  json_decode(base64_decode($_GET['requisition_id']));
            //$query=(mysqli_query($connection,"UPDATE requisition SET status='Waiting for Approve' WHERE requisition_id=$requisitionId"));
                ...
                <tbody> 
                  ...
                  <tr>
                     ...
                     <td class="text-nowrap">
                       <div class="btn-group">
                          <a class="btn btn-primary btn-sm" href="view-requisition-detail.php?requisition_id=<?= $requisition['requisition_id']; ?>"><i class="fa fa-cowbell">&nbsp;View Items requested</i></a>
                       </div>
                     </td>
				  </tr>
                    <?php 
