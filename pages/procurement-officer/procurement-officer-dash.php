...
<head>
  ...
  <title>Banja | Procurement Officer| Dashboard</title>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="expiry-items.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Expiry items</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"><span id="date_time"></span></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
        <?php if($sess)
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            ?>
              <div class="inner">
                <h3><?php echo $countExpiryDate;?></h3>
                <p>Expiry Items</p>
              </div>
              <div class="icon">
                <i class="fas fa-calendar-alt" aria-hidden="true"></i>
				</div>
              <a href="expiry-items.php" class="small-box-footer">More info<i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <?php
                  $query = mysqli_query($connection, "SELECT * FROM transfer"); 
                  $count= mysqli_num_rows($query);
              ?>
              <div class="inner">
              ...
              <a href="stock-transfer.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
               <?php
                  $query = mysqli_query($connection, "SELECT * FROM requisition"); 
                  $count= mysqli_num_rows($query);
              ?>
              <div class="inner">
                <h3><?php echo $count; ?></h3>
              ...
              <a href="requisition-summary.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
