...
<head>
  ...
  <title>Banja | Finance Director| Expiry Items</title>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="expiry-items.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Expiry Items</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Items Expiry Details</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="finance-director-dash.php">Home</a></li>
              <li class="breadcrumb-item active">Items Expiry Details</li>
            </ol>
          </div>
        </div><!-- /.row -->
        <?php if($sess)
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Items Expiry Details</h3>
            ...
            <div class="table-responsive">
                ...
                <?php 
                    ...
                    if(mysqli_num_rows($results) > 0)
                    {
                      ...
                      { 
                       ...
                       /*$ExpiredDate = "UPDATE item SET expiry_status ='". $item['expiry_status']."'";
                       $echoExpiredDate = mysqli_query($connection, $ExpiredDate);*/
                  ?>
                  <tr>
              ...
              <!-- /.end table -->
                ...
                <nav aria-label="...">
                    ...
                    <?php if($page > 1){ ?>
                    <li class="page-item">
                        <a class="page-link" href="expiry-items.php?page=<?= $previous; ?>">Previous</a>
                      </li>
                      <?php 
                       } else { ?>
                      ...
                      <li class="page-item <?= $page == $i ? 'active':'' ?>" aria-current="page">
                            <a class="page-link" href="expiry-items.php?page=<?= $i; ?>"><?= $i; ?></a>
                      </li>
                      <?php endfor; ?>
                       
                      <?php if(($i > $page) && ($page < $pages)){ ?>
                      <li class="page-item">
                        <a class="page-link" href="expiry-items.php?page=<?= $next; ?>">Next</a>
                      </li>
                      <?php 
                       } else { ?>
                      <li class="page-item disabled">
