<?php
    ...
    if (!isset ($_SESSION['procurement-officer']))
       ...
       if(isset($_GET['team_code']))
	  {
        ...
        $teamId = mysqli_real_escape_string($connection, $_GET['team_code']);
		
		$results = $connection->query("SELECT * FROM team
...
<head>
  ...
  <title>Banja | Procurement Officer | Team Details</title>
                ...
                <tbody> 
                  ...
                  <tr>
                     ...
                     <?php 
                      ...
                      echo '<tr><td colspan="3" class="text text-danger font-weight-bold">There are currently no team records to display</td></tr>';
                    }?>
                </tbody>
              </table>
              <!-- /.end table -->
