      ...
      <li class="nav-item dropdown">
        ...
        <?php
               if(mysqli_num_rows($query)>0){
                   ...
                   echo '<a href="purchase-requisition" class="dropdown-item dropdown-footer">See All Requisitions</a>';
                }
                else{
                  echo '
        ...
        <?php     
          ...
          <a href="#" class="dropdown-item">
            <?php 
                ...
                {
            ?>
            <i class="fas fa-envelope mr-2"></i><?php echo $countRequisition; ?>&nbsp;Message(s)
          ...
          <a href="#" class="dropdown-item">
            <?php
               ...
               <span class="float-right text-muted text-sm">10 min</span>
               <?php
                  }
                  else
                  { ?>
							...
							$comment = mysqli_real_escape_string($connection, $_POST['comment']);
                             ...
                             if(!$msg)
                             {
                                $update=(mysqli_query($connection,
			                                          ...
			                                          ON requisition.requisition_id=requisition_details.requisition_id 
			                                          SET requisition.status='Approved', requisition.date_replied=NOW(), 
