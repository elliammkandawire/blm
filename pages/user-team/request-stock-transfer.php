...
<head>
  ...
  <title>Banja | User team | Request Stock Transfer</title>
                  ...
                  if (isset($_POST['submit']))
                  {
                    ...
                    if(!$msg)
                    {
                        ...
                        $insert = (mysqli_query($connection,"INSERT INTO transfer(item_code, item_name, quantity, source, destination, specification, date_requested)
                                                            VALUES('$item_code', '$item_name', '$quantity2', '$teamCode', '$destination', '$specification', NOW())"));
                        if ($update && $insert)
                        {
               ...
               <!-- form start -->
                ...
                <div class="form-row">
                   <div class="col-md-6 form-group">
                    ...
                    <input type="text" name="item_code" value="<?php echo"$item_code"; ?>" class="form-control disabled" id="item_code" disabled />
                   </div>
                   <div class="col-md-6 form-group">
                    <label for="item_name">Item Name</label>
                    <input type="text" name="item_name" value="<?php echo"$item_name"; ?>" class="form-control disabled" id="item_name" disabled />
                  </div>
                </div>
