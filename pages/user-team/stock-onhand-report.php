<?php
    ...
    if (!isset ($_SESSION['user-team']))
	  ...
	  {	
	      $filename = "stock-on-hand-".date('d-m-y'). ".xls";			
...
<head>
  ...
  <title>Banja | user-team | Stock On-hand Report</title>
		    ...
		    <div class="row no-print">
		      <div class="col-sm-6">
			    <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">
				  ...
				  <a href="stock-onhand-report-print.php" rel="noopener" target="_blank" class="btn btn-secondary"><i class="fas fa-print"></i>&nbsp;Print Stock on hand</a>
			    </form>
			  </div>
			 </div>
			<br>
