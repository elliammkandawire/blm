<?php
    ...
    if (!isset($_SESSION['user-team']))
        ...
        if(isset($_GET['file_id']))
        {
                ...
                $sql = "SELECT * FROM upload WHERE file_id = $file_id";
                ...
                if(file_exists($filepath))
                {
                  ...
                  exit;
                    ...
                    $msg [] = "The selected file does not exist or it has been deleted";
                }
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
   <title>Banja | user team | Downloads</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="approved-requisition.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Approved Requisitions</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="denied-requisition.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Denied Requisition</p>
                </a>
              </li>
              <li class="nav-item">
