...
if(isset($_POST['start']) && isset($_POST['end'])){
    ...
    $results = mysqli_query($connection, "SELECT *  
	  ...
	  {	
	      $filename = "stock-usage-report-".date('d-m-y'). ".xls";			
...
<head>
  ...
  <title>Banja | User team | Stock Usage Report</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
			  ...
			  <li class="nav-item">
                <a href="stock-usage-report.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Stock Usage</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Stock Usage Details</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="user-team-dash.php">Home</a></li>
              <li class="breadcrumb-item active">Stock Usage Details</li>
            </ol>
          </div>
        </div><!-- /.row -->
        <?php if($sess)
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">All stock Usage Details</h3>
            ...
            <div class="table-responsive">
               ...
               <table id="stockUsageTable" class="table table-striped table-advance table-bordered">
                ...
                ?>
                  <tr>
                     <td><?= $item['stock_usage_id']; ?></td>
					 <td><?= $item['item_code']; ?></td>
                     <td><?= $item['item_name']; ?></td>
                     <td><?= $item['specification']; ?></td>
                     <td><?= $item['category']; ?></td>
                     <td><?= $item['unit']; ?></td>
					 <td class="text-danger"><?= $item['quantity_taken']; ?></td>
                  ...
                  <?php 
                     ...
                     <?php 
                      ...
                      echo '<tr><td colspan="11" class="text text-danger font-weight-bold">There are currently no item details to display</td></tr>';
                    }?>
                </tbody>
              </table>
              <!-- /.end table -->
                ...
                <nav aria-label="...">
                    ...
                    <?php if($page > 1){ ?>
                    <li class="page-item">
                        <a class="page-link" href="stock-usage-report.php?page=<?= $previous; ?>">Previous</a>
                      </li>
                      <?php 
                       } else { ?>
                      ...
                      <li class="page-item <?= $page == $i ? 'active':'' ?>" aria-current="page">
                            <a class="page-link" href="stock-usage-report.php?page=<?= $i; ?>"><?= $i; ?></a>
                      </li>
                      <?php endfor; ?>
                       
                      <?php if(($i > $page) && ($page < $pages)){ ?>
                      <li class="page-item">
                        <a class="page-link" href="stock-usage-report.php?page=<?= $next; ?>">Next</a>
                      </li>
                      <?php 
                       } else { ?>
                      <li class="page-item disabled">
