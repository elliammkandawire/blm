...
<head>
  ...
  <title>Banja | User team | Uploads</title>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
			 <li class="nav-item">
                <a href="upload-file.php" class="nav-link active">
    ...
    <section class="content">
      <div class="container-fluid">
            ...
            <div class="card card-primary">
			  ...
			  <?php
                    ...
                    if(isset($_FILES['file']))
	                {
		                ...
		                if(!in_array($extension,["doc","DOC", "JPG", "jpg", "PNG", "png", "docx","DOCX","pdf","PDF"]))
		                {
						...
						{
							$msg[] = $_FILES['file']['name'] . " already exists, Please upload a file with a different name";
						}
		                else
		                {
			                if(!$msg)
        ...
        ?>	
            ...
            <div class="card-body">
               <!-- form start -->
                <form id="uploadForm" class="uploadForm" action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-footer">
                    <button type="submit" name="submit" id="submit" class="btn btn-primary"><i class="fa fa-upload"></i>&nbsp;Upload File</button>
				</div>
				<!-- / .card footer -->
              </form>
            </div>
