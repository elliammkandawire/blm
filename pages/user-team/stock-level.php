<?php
    ...
    if (!isset ($_SESSION['user-team']))
      ...
      $results = $connection->query("SELECT *  
                                    ...
                                    WHERE item.quantity <= 20
									AND item.team_code = $teamCode
                                    ORDER BY item.quantity ASC LIMIT $start, $limit");
...
<head>
  ...
  <title>Banja | User team | Stock Level</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Stock Level details</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="warehouse-dash.php">Home</a></li>
              <li class="breadcrumb-item active">Stock Level details</li>
            </ol>
          </div>
        </div><!-- /.row -->
        <?php if($sess)
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Stock level Details</h3>
            ...
            <div class="table-responsive">
                ...
                <?php 
                  ...
                  <tr>
                      ...
                      <?php }
                        ...
                        echo '<tr><td colspan="12" class="text text-danger font-weight-bold">There are currently no item with low or high stock level</td></tr>';
                      }
                      ?>
                </tbody>
              </table>
              <!-- /.end table -->
                ...
                <nav aria-label="...">
                    ...
                    <?php if($page > 1){ ?>
                    <li class="page-item">
                        <a class="page-link" href="stock-level.php?page=<?= $previous; ?>">Previous</a>
                      </li>
                      <?php 
                       } else { ?>
                      ...
                      <li class="page-item <?= $page == $i ? 'active':'' ?>" aria-current="page">
                            <a class="page-link" href="stock-level.php?page=<?= $i; ?>"><?= $i; ?></a>
                      </li>
                      <?php endfor; ?>
                       
                      <?php if(($i > $page) && ($page < $pages)){ ?>
                      <li class="page-item">
                        <a class="page-link" href="stock-level.php?page=<?= $next; ?>">Next</a>
                      </li>
                      <?php 
                       } else { ?>
                      <li class="page-item disabled">
