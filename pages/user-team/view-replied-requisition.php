      ...
      if(isset($_GET['requisition_id']))
        {
            ...
            $query=(mysqli_query($connection,"UPDATE requisition SET view_status=1 WHERE requisition_id=$requisitionId"));
...
<head>
  ...
  <title>Banja | User team | View Requisition Reply</title>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Replied Requisitions</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="user-team-dash.php">Home</a></li>
              <li class="breadcrumb-item active">replied Requisitions</li>
            </ol>
          </div>
        </div><!-- /.row -->
        <?php if($sess)
                ...
                <tbody> 
                  ...
                  <tr>
                     ...
                     <td class="text-nowrap">
                       <div class="btn-group">
                          <a class="btn btn-primary btn-sm" href="view-replied-requisition-detail.php?requisition_id=<?= $requisition['requisition_id']; ?>"><i class="far fa-cowbell-more">&nbsp;View Details</i></a>
                       </div>
                    </td>
                  </tr>
                      <?php 
