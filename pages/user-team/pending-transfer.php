...
<head>
  ...
  <title>Banja | User team | Pending Stock Transfer</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="pending-transfer.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Requested Transfers</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="user-team-dash.php">Home</a></li>
              <li class="breadcrumb-item active">Requested transfers</li>
            </ol>
          </div>
        </div><!-- /.row -->
        <?php if($sess)
            ...
            <div class="table-responsive">
               ...
               <table class="table table-striped table-bordered" id="pending_tranfer">
                ...
                <?php 
                 ...
                 ?>
                  <tr>
                     <td><a href="item-detail.php?item_code=<?= $item['item_code']; ?>"><?= $item['item_code']; ?></a></td>
                     ...
                     <td>
                        <div class="btn-group">
                          <a class="btn btn-primary" href="#?transfer_id=<?= $item['transfer_id']; ?>"><i class="fa fa-edit">&nbsp;Edit</i></a>
                        </div>
                     </td>
                  </tr>
                  <?php 
                     ...
                     <?php 
                      ...
                      echo '<tr><td colspan="8" class="text text-danger font-weight-bold">There are currently no pending Transfers</td></tr>';
                    }?>
                </tbody>
              </table>
              <!-- /.end table -->
                ...
                <nav aria-label="...">
                    ...
                    <?php if($page > 1){ ?>
                    <li class="page-item">
                        <a class="page-link" href="pending-transfer.php?page=<?= $previous; ?>">Previous</a>
                      </li>
                      <?php 
                       } else { ?>
                      ...
                      <li class="page-item <?= $page == $i ? 'active':'' ?>" aria-current="page">
                            <a class="page-link" href="pending-transfer.php?page=<?= $i; ?>"><?= $i; ?></a>
                      </li>
                      <?php endfor; ?>
                       
                      <?php if(($i > $page) && ($page < $pages)){ ?>
                      <li class="page-item">
                        <a class="page-link" href="pending-transfer.php?page=<?= $next; ?>">Next</a>
                      </li>
                      <?php 
                       } else { ?>
                      <li class="page-item disabled">
