...
<head>
  ...
  <title>Banja | User team | Transfer Stock</title>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="transfer-stock.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Transfer stock</p>
                </a>
              </li>
               ...
               <table class="table table-striped table-advance table-bordered">
                ...
                <?php
                  ...
                  <tr>
                     ...
                     <td>
                        <div class="btn-group">
                          <a class="btn btn-primary" href="request-stock-transfer.php?item_id=<?= $item['item_id']; ?>&item_code=<?= $item['item_code']; ?>&item_name=<?= $item['item_name']; ?>&quantity=<?= $item['quantity']; ?>"><i class="fa fa-paper-plane">&nbsp;Transfer</i></a>
                        </div>
                     </td>
                  </tr>
                    <?php } ?>
