<?php
    ...
    if (!isset ($_SESSION['warehouse']))
      ...
      if (isset($_POST['search']) and !empty($_POST['search']))
      {
		  ...
		  OR date_requested LIKE '$keywords%'
		  AND team_code=$teamCode
		  ORDER BY date_requested DESC LIMIT $start, $limit");
          $requisitions = mysqli_fetch_all($results, MYSQLI_ASSOC);

         $result1 = $connection->query("SELECT COUNT(requisition_id) AS id FROM requisition WHERE team_code=$teamCode");
      ...
      {
         $results = $connection->query("SELECT * FROM requisition WHERE team_code=$teamCode ORDER BY date_requested DESC LIMIT $start, $limit");
...
<head>
  ...
  <title>Banja | Warehouse | Requisition Summary</title>
        ...
        <div class="navbar-search-block">
          <form class="form-inline" method="post" action="">
            <div class="input-group input-group-sm">
              <input class="form-control form-control-navbar" type="search" name="search" placeholder="Search by requisition status or date requisition was sent" aria-label="Search">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Requisition Summary</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            ...
            <div class="card-body">
              ...
              <div class="table-responsive">
                <!-- table start -->
                <table class="table table-striped table-advance table-hover table-bordered" id="requisition_table">
                ...
                <tbody> 
                  ...
                  <tr>
					 ...
					 <td><?= $requisition['time_taken']; ?></td>
                     <td><a href="team-detail.php?team_code=<?= $requisition['team_code']; ?>"><?= $requisition['team_code']; ?></a></td>
                      <td class="text-nowrap">
                       <div class="btn-group">
                          <a class="btn btn-primary btn-sm" href="view-replied-requisition-detail.php?requisition_id=<?= $requisition['requisition_id']; ?>"><i class="fa fa-cowbell">&nbsp;View Details</i></a>
                       </div>
                     </td>
				  </tr>
                    <?php } ?>
                   ...
                   { ?>
                       <tr><td colspan="8" class="text text-danger font-weight-bold">No search results found</td></tr>
                  <?php }  ?>
                </tbody>
              </table>
              <!-- /.end table -->
