...
<head>
  ...
  <title>Banja | Warehouse | View Requisitions</title>
                ...
                <tbody> 
                  ...
                  <tr>
                     ...
                     <td class="text-nowrap">
                       <div class="btn-group">
                          <a class="btn btn-primary btn-sm" href="view-replied-requisition-detail.php?requisition_id=<?= $requisition['requisition_id']; ?>"><i class="fa fa-cowbell">&nbsp;View Items requested</i></a>
                       </div>
                     </td>
				  </tr>
                    <?php 
