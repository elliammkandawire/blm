<?php
    ...
    <?php
	  ...
	  {	
		 ...
		 $filename = "Stock-report-".date('d-m-y'). ".xls";			
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item  menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="stock-report.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Stock Report</p>
                </a>
              </li>
               ...
               <table id="stockTable" class="table table-striped table-bordered">
                <thead class="text-nowrap">
                  <tr>
                    ...
                    <th>Batch</th>
                    <th>GRN</th>
					<th>Daily Average Consumption</th>
					<th>Minimum Stock Level</th>
					<th>Maximum Stock Level</th>
					<th>Expiry Remaining Days</th>
					<th>Quantity Before Expiry</th>
					<th>Quantity at Risk of Expiry</th>
					<th>Stock Value Expiry Risk</th>
                    <th>Team Code</th>
                  </tr>
                </thead>
                <tbody>
                <?php
                  ...
                  <tr>
                     ...
                     <td><?= $item['batch']; ?></td>
                     <td><?= $item['GRN']; ?></td>
					 <td><?= round($item['daily_average_consumption'], 2); ?></td>
					 <td><?= $item['minimum_stock_level']; ?></td>
					 <td><?= $item['maximum_stock_level']; ?></td>
					 <td><?= $item['expiry_remaining_days']; ?></td>
					 <td><?= $item['quantity_before_expiry']; ?></td>
					 <td><?= $item['quantity_risk_expiry']; ?></td>
					 <td><?= number_format($item['stock_value_expiry_risk'], 2); ?></td>
                  ...
                  <?php } ?>
                   ...
                   { ?>
                       <tr><td colspan="28" class="text text-danger font-weight-bold">No search results found</td></tr>
                  <?php }  ?>
                </tbody>
              </table>
              <!-- /.end table -->
                ...
                <div class="card-footer no-print">
                   <nav aria-label="...">
                    ...
                    <?php if($page > 1){ ?>
                    <li class="page-item">
                        <a class="page-link" href="stock-report.php?page=<?= $previous; ?>">Previous</a>
                      </li>
                      <?php 
                       } else { ?>
                      ...
                      <li class="page-item <?= $page == $i ? 'active':'' ?>" aria-current="page">
                            <a class="page-link" href="stock-report.php?page=<?= $i; ?>"><?= $i; ?></a>
                      </li>
                      <?php endfor; ?>
                       
                      <?php if(($i > $page) && ($page < $pages)){ ?>
                      <li class="page-item">
                        <a class="page-link" href="stock-report.php?page=<?= $next; ?>">Next</a>
                      </li>
                      <?php 
                       } else { ?>
                      <li class="page-item disabled">
...
<!--				  <a href="stock-details-print.php" rel="noopener" target="_blank" class="btn btn-secondary"><i class="fas fa-print"></i>&nbsp;Print Stock report</a>-->
<!--			    </form>-->
<!--			  </div>-->
<!--			 </div>-->
