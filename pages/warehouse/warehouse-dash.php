...
<head>
  ...
  <title>Banja | Warehouse | Dashboard</title>
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            ?>
              ...
              <a href="item-expiry-date.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
             <?php
                  $query = mysqli_query($connection, "SELECT * FROM transfer WHERE source ='$teamCode' OR destination = '$teamCode'");
                  $count= mysqli_num_rows($query);
              ?>
              <div class="inner">
              ...
              <a href="pending-transfer.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="order-summary.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
               <?php
                  $query = mysqli_query($connection, "SELECT * FROM requisition WHERE team_code ='$teamCode'"); 
                  $count= mysqli_num_rows($query);
              ?>
              <div class="inner">
                <h3><?php echo $count; ?></h3>
              ...
              <a href="requisition-summary" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
