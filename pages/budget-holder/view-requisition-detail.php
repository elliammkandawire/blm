...
<head>
  ...
  <title>Banja | Budget Holder | View Requisitions</title>
			    ...
			    <?php
                        ...
                        if(isset($_POST['approve']))
                        {
							...
							$comment = mysqli_real_escape_string($connection, $_POST['comment']);
                             ...
                             if(!$msg)
                             {
                                $update1=(mysqli_query($connection,"UPDATE requisition 
                        ...
                        if(isset($_POST['deny']))
                        {
                            ...
                            $update1=(mysqli_query($connection,
							                         "UPDATE requisition 
	                                                  JOIN requisition_details
			                                          ON requisition.requisition_id=requisition_details.requisition_id 
			                                          SET requisition.status='Denied', requisition.view_status=2, 
			                                          requisition.date_replied=NOW(), requisition.comment2='$comment', 
			                                          requisition_details.reply_status=2 
	                                                  WHERE requisition.requisition_id='$requisitionId'"));
                              if (!$update1)
