<?php
     ...
     $sess = array();
    if (!isset ($_SESSION['finance-director']))
        {
		    ...
		    if ($now > $_SESSION['expire'])
        {
	      ...
	      $user_check = $_SESSION['finance-director']; // Stored Session for current logged user
...
<head>
  ...
  <title>Banja | Finance Director | View Requisitions</title>
...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a title="Messages" class="nav-link" data-toggle="dropdown" href="#">
          ...
          <?php
               $query = mysqli_query($connection, "SELECT * FROM requisition WHERE reply_status='Replied' AND view_status=2 AND comment2 !='Waiting for Approval' ORDER BY date_requested DESC LIMIT 4"); 
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="finance-director-dash.php" class="brand-link">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="finance-director-dash.php">Home</a></li>
                             ...
                             if(!$msg)
                             {
                                $update=(mysqli_query($connection,
								                      "UPDATE requisition 
			                                           ...
			                                           ON requisition.requisition_id=requisition_details.requisition_id 
			                                           SET requisition.status='Approved', requisition.view_status=3, 
