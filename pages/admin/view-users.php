        ...
        if (isset($_POST['submit'])){
		  ...
		  if(!empty($_POST['teamCode'])){
            ...
            if (mysqli_num_rows($results)==0){
              $msg[] = "The entered team code does not exist, please refer to Team Details table for all the required team code";
            }
          }
                ...
                <tbody> 
                  ...
                  <tr>
                     ...
                     <td class="text-nowrap">
					    <div class="btn-group">
                              <a class="btn btn-primary btn-sm editUser" href="#" id="<?= $user['id']; ?>"><i class="fa fa-edit">&nbsp;Edit</i></a>
							  <a class="btn btn-danger btn-sm deleteUser" href="#" id="<?= $user['id']; ?>"><i class="fa fa-times">&nbsp;Delete</i></a>
					    </div>
					</td>
                  </tr>
                      <?php 
                     ...
                     <?php 
                      ...
                      echo '<tr><td colspan="9" class="text text-danger font-weight-bold">There are currently no user records to display</td></tr>';
                    }?>
                </tbody>
              </table>
              <!-- /.end table -->
                ...
                <div class="card-footer">
                    ...
                    <?php if($page > 1){ ?>
                    <li class="page-item">
                        <a class="page-link" href="add-user.php?page=<?= $previous; ?>">Previous</a>
                      </li>
                      <?php 
                       } else { ?>
                      ...
                      <li class="page-item <?= $page == $i ? 'active':'' ?>" aria-current="page">
                            <a class="page-link" href="add-user.php?page=<?= $i; ?>"><?= $i; ?></a>
                      </li>
                      <?php endfor; ?>
                       
                      <?php if(($i > $page) && ($page < $pages)){ ?>
                      <li class="page-item">
                        <a class="page-link" href="add-user.php?page=<?= $next; ?>">Next</a>
                      </li>
                      <?php 
                       } else { ?>
                      <li class="page-item disabled">
		    ...
		    <div class="modal fade" id="editUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog  modal-lg" role="document">
               ...
               <div class="modal-body">     
                       <!-- form start -->
               <form id="orderForm" name="orderForm" method="POST" action="update-user.php" >
               <div class="form-row">
                  <div class="col-md-12 form-group">
                    <input type="hidden" name="userId" class="form-control" id="userId" data-rule-required="true" data-msg-required="Please enter item number" />
                  </div>
			    </div>
			   <div class="form-row">
                <div class="col-md-6 form-group">
				  <label for="firstname">Firstname:</label>
                  <input type="text" name="firstname" class="form-control" id="firstname" placeholder="User Firstname" data-rule-required="true" data-msg-required="Please enter user firstname" />
                </div>
				<div class="col-md-6 form-group">
                ...
                <div class="form-row">
			       <div class="col-md-6 form-group">
				     <label for="userType">User Type:</label>
                      <select class="form-control" name="userType" id="userType" data-rule-required="true" data-msg-required="Please select user type">
                ...
                <div class="modal-footer">
                  ...
                  <button type="submit" name="submit" id="submit" class="btn btn-primary">Update User details</button>
                </div>
              </form>
...
<!---Edits users-->
<script src="../../dist/js/edit-user.js"></script>
<!---Updates User in User table-->
<script src="../../dist/js/update-user.js"></script>
<!---Deletes User in User table-->
<script src="../../dist/js/delete-user.js"></script>
</body>
</html>